...
div.thread-item-circle {
    ...
    background-color: var(--article-thread-line-light-4);
    color: var(--article-thread-line-light-20);
    border-radius: 100%;

    &-fill {
        background-color: var(--article-thread-line-light-20);
        border-radius: 100%;
    }
...
li.thread-item-trailing {
    ...
    div.thread-item-circle {
        background-color: var(--article-thread-line-light-3);
        &-fill { display: none; }
