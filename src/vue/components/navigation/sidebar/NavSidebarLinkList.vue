...
::-webkit-scrollbar-thumb {background: var(--nav-background-light-20);-webkit-box-shadow: rgba(155,155,155)}
::-webkit-scrollbar-thumb:window-inactive {background: var(--nav-background-light-10);}
...
div.nav-sidebar-links-wrapper-shrink {
    ...
    button.nav-sidebar-link {
        ...
        span {
            ...
            border: 2px solid var(--nav-highlight-dark-2);
